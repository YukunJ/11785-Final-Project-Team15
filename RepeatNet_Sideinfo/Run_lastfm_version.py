...
item_vocab_size = 107390 + 1 + 1

def train(args):
    batch_size = 256

    #train_dataset = RepeatNetDataset(base_data_path+'demo.train')
    train_dataset = RepeatNetDataset(base_data_path+'lastfm_train.artist.txt')
...
def infer(args):
    batch_size = 256
    epoches = 1
    valid_dataset = RepeatNetDataset(base_data_path + 'lastfm_valid.artist.txt')
    test_dataset = RepeatNetDataset(base_data_path + 'lastfm_test.artist.txt')
